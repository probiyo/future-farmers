...
with tab1:
    with st.form("pro_form", clear_on_submit=True):
        ...
        with col1:
            ...
            # Güncelleme 1: Tüm ölçek açıklamalarının listelenmesi
            st.write("---")
            for k, v in t["stress_help"].items():
                st.caption(f"{v}")
            st.write("---")
        ...
        with col2:
            ...
            if photo_choice == t["upload"]:
                ...
                # Güncelleme 2: Kamera widget'ına 'key' eklendi
                uploaded_file = st.camera_input(t["camera"], key="main_camera")
        ...
        if submitted:
            data_to_send = {
                ...
                "Notlar": notes,
                "Foto_Base64": "Gelecek_Sürümde_Eklenecek" 
            }
