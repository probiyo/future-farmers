...
# --- AYARLAR ---
# Google Sheets URL'nizi güncellediğinizden emin olun (CSV yayınlama linki)
...
with tab2:
    ...
    try:
        ...
        if not df.empty:
            # Sheets'teki sütun isimlerine göre grafik çiziyoruz
        ...
        st.error(f"VERİ HAVUZUNA BAĞLANILAMADI. Hata detayı: {e}")
